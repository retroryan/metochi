...
public class JwtAuthService {
    ...
    public void authorization(String rawJWT) {
        try {
            DecodedJWT jwt = jwtFromToken(rawJWT);
            String username = jwt.getSubject();
            String isAuthority = IS_AUTHORITY;
            jwt.getClaim(isAuthority);
        } catch (JWTVerificationException e) {
            logger.info("JWT decoding exception");
        }
    }
}
